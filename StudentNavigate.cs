...
namespace lab10
{
    public partial class StudentNavigate : Form
    {
        ...
        public StudentNavigate(string ccode)
        {
            StudentNavigate.currentClassCode = ccode;
            this.handler = new DBHandler();
            this.connection = new SqlConnection(this.handler.MyConnection());
            this.InitializeComponent();
            try
            {
                ...
                this.command.Parameters.AddWithValue("@reqCode", (object)StudentNavigate.currentClassCode);
                ...
                if (this.dataReader.HasRows)
                {
                    ...
                    this.setInfo(className, StudentNavigate.currentClassCode,classSection, "");
        ...
        public void getAllPeople()
        {
            try
            {
                ...
                this.command.Parameters.AddWithValue("@ccode", (object)StudentNavigate.getCurrClassCode());
                this.dataReader = this.command.ExecuteReader();
        ...
        public void getAllPosts()
        {
            try
            {
                ...
                this.command.Parameters.AddWithValue("@cCode", (object)StudentNavigate.currentClassCode);
                this.dataReader = this.command.ExecuteReader();
                if (this.dataReader.HasRows)
                {
                    while (this.dataReader.Read())
